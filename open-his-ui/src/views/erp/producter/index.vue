  ...
  <div class="app-container">
    ...
    <el-form ref="queryForm" :model="queryParams" :inline="true" label-width="98px">
      <el-form-item label="厂家名称" prop="producterName">
        <el-input v-model="queryParams.producterName" placeholder="请输入厂家名称" clearable size="small" style="width:180px" />
      </el-form-item>
      ...
      <el-form-item label="厂家电话" prop="producterTel">
        <el-input v-model="queryParams.producterTel" placeholder="请输入厂家电话" clearable size="small" style="width:180px" />
      </el-form-item>
      ...
      <el-form-item label="创建时间">
        <el-date-picker v-model="dateRange" size="small" style="width:240px" value-format="yyyy-MM-dd" type="daterange" range-separator="-" start-placeholde="开始日期" end-placeholde="结束日期" />
      </el-form-item>
      <el-form-item>
    ...
    <!-- 数据表格结束 -->
    <!-- 分页控件开始 -->
    <el-pagination v-show="total>0" :current-page="queryParams.pageNum" :page-sizes="[5, 10, 20, 30]" :page-size="queryParams.pageSize" layout="total, sizes, prev, pager, next, jumper" :total="total" @size-change="handleSizeChange" @current-change="handleCurrentChange" />
    <!-- 分页控件结束 -->
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        ...
        <el-form-item label="状态" prop="status">
          <el-radio-group v-model="form.status">
            <el-radio v-for="dict in statusOptions" :key="dict.dictValue" :label="dict.dictValue" :value="dict.dictValue">{{ dict.dictLabel }}</el-radio>
          </el-radio-group>
        </el-form-item>
      </el-form>
